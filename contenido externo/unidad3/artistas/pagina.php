...
<body>
    ...
    <main>
        <header>
            <img src="images/ralogo_monogram.png" alt="imagen">
            <p>
                Roux Academy
               <br>
               *Art
            ...
            <div>
                <h2>Design Roux Academy 2016 Art Conference</h2>
                <br>
        ...
        <nav>
            <ul>
                ...
                <li><a href="horarios.html">Schedule</a></li>
                <li><a href="venue.html">Venue/Travel</a></li>
                <li><a href="register.html">Register</a></li>
            </ul>
        </nav>
        <banner>
            <img src="images/art01.jpg" alt="imagen">
        </banner>
        <section>
            <article>
                ...
                selected as a Featured Artist.</p><br>
                <h2>Featured artist</h2><br>
                ...
                <h4>hotel Contempo</h4>
                    <img src="images/hotel_contempo.jpg" alt="imagen" id="ajustable">
            ...
            <aside>
                ...
                Our mobile site contains schedules, and exhibit/ artist details, accessible simply by
                scanning QR codes located all around the venue exhibit halls.
                <br>
                <figure>
                    <img src="images/iphone.png" alt="imagen">
                    <figcaption id="telefon"><a href="register.html">roux mobile>></a></figcaption>
                </figure>

                <h2 id="negro">Schedule</h2>
                <h3>Monday</h3>
                The first day of CAC events is kicked off under the theme of Art in Full Color. From
                a demonstration in graffiti art on a wall of the Rousseau Room, to the exhibit of
                colorful glazed modern glassware in the Dover Hall.
                <h3>Tuesday</h3>
                Water in Art is the theme for the second day, as art students gather at the Fountain
                of Intrigue to create ice sculptures, and art lecturers discuss the use of water as an
                art material, and water as an art subject.
                <figcaption id="telefon"><a href="horarios.html">Full Schedule>></a></figcaption>
            </aside>
        </section>
        <footer>
            <img src="images/ralogo_monogram.png" alt="imagen">
            ...
            <div>
                <p>About the Roux Academy|Privacy and policy|Visit our website</p>
            </div>
        </footer>
    </main>
</body>
